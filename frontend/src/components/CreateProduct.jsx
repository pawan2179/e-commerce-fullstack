...
const CreateProduct = () => {
  ...
  const handleSubmit = async(event) => {
    ...
    try {
      ...
      console.log("Something went wrong when creating new product");
    }
  }
  ...
  return (
    <motion.div
      className='bg-gray-800 shadow-lg rounded-lg p-8 m-8 max-w-xl mx-auto'
